            ...
            <div class="max-w-1/2 mx-auto">
                ...
                <form action="{{ route('update.classe', ['id' => $classe->id]) }}" method="post"
                    ...
                    <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                        <div x-data="{ photoName: null, photoPreview: null }" class="col-span-6 ml-2 sm:col-span-4 md:mr-3">
                            <!-- Photo File Input -->
                            <input type="file" name="classPicture" class="hidden" x-ref="photo"
                                value="{{ old('classPicture') }}"
                                x-on:change="
                ...
                ">
                            ...
                            <label class="block text-gray-700 text-sm font-bold mb-2 text-center" for="photo">
                                Class Photo <span class="text-red-600"> </span>
                            </label>
                            ...
                            <div class="text-center">
                                ...
                                <button type="button"
                                    ...
                                    x-on:click.prClass="$refs.photo.click()">
                                    Select New Photo
                                </button>
                                @error('classPicture')
