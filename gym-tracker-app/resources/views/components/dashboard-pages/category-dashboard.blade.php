...
<main class="ease-soft-in-out relative h-full max-h-screen rounded-xl transition-all xl:ml-68 duration-200">
    ...
    <div class="space-y-2 text-center mt-16 mb-10">
        <h2 class="text-3xl font-bold">All Category</h2>
        <p class="font-serif text-sm dark:text-gray-400">Here you can add and see all category.</p>
    </div>
                    ...
                    <div class="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0">
                        <div
                            ...
                            <div class="flex-auto p-6">
                                <form role="form text-left" action="{{ route('store.category') }}" method="post">
                                    @csrf
                                    <div class="mb-4">
                                        <input type="text"
                                            class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                            name="name" placeholder="Write the catgeory name ..." aria-label="Name"
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <button data-modal-target="crud-modal-{{ $category->id }}"
                                                        ...
                                                        type="submit">
                                                        <svg class="w-5 h-5 mx-1" fill="none"
                                                    ...
                                                    <!-- Main modal -->
                                                    <div id="crud-modal-{{ $category->id }}" tabindex="-1"
                                                        aria-hidden="true"
                                                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                                            <!-- Modal content -->
